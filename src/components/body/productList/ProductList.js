        ...
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="flex flex-wrap -m-2">
            {Materials.slice(0, 8).map((Item) => (
              <div key={Item.id} className="lg:w-1/4 md:w-60 p-4 w-1/2">
                <div className="relative block w-full bg-gray-900 group md:h-72 h-96">
                <Link to={`/Products/${Item.id}`} >
                  <img
                    
                    className="absolute inset-0 object-cover w-full h-96 md:h-72 group-hover:opacity-100 cursor-pointer"
                    src={Item.image}
                  /></Link>
