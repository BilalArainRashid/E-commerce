...
const LeftBar = ({ onFilterChange, products }) => {
  const [currentIndex, setCurrentIndex] = useState(0);
  
 

  const allData = (all) => {
    const updatedList = products.filter(item =>item.all=== all);
  ...
  const filterSizeProduct = (size) => {
    const updatedList = products.filter((item) => item.size === size);
    onFilterChange(updatedList);
    console.log(updatedList);
    
  }
  const filterColorProduct = (color) => {
    const updatedList = products.filter((item) => item.color === color);
    onFilterChange(updatedList);
    console.log(updatedList);
      ...
      <div>
        ...
        <div className="relative w-[280px] -b ">
          ...
          <div className=" h-12 w-full flex items-center ">
            <h1 className="font-semibold pl-4 cursor-pointer" onClick={()=>allData("all")} >All Categories</h1>
          </div>
          ...
          <div className="flex bg-white overflow-hidden transition-all duration-1000 max-h-45    peer-checked:max-h-0">
            <div className="p-4">
              <nav className="flex flex-col space-y-3 list-none -b-2">
                <li>
                  <a className="text-black font-medium hover:text-red-700 cursor-pointer" onClick={()=>filterCatProduct("Women's clothing")}  >
                    Jeans
                  </a>
                </li>
                <li>
                  <a className="text-black font-semibold hover:text-red-700 cursor-pointer" onClick={()=>filterCatProduct("men's clothing")}>
                    Jacket&Coats
                  </a>
                </li>
                <li>
        ...
        <div className="relative w-[280px] -b ">
          ...
          />
          <div className=" h-12 w-full flex items-center ">
            <h1 className="font-semibold pl-4">Sized</h1>
          </div>
                  ...
                  <div className="row flex  w-full justify-between  mr-4">
                    <div className="row flex items-center">
                      {/* <input
                        ...
                        type="checkbox"
                        value=""
                        onClick={()=>filterSizeProduct("S")}
                        className="w-4 h-4"
                      /> */}
                      <a className="ml-2 text-sm font-medium text-gray-700 hover:text-red-700 cursor-pointer " onClick={()=>filterSizeProduct("S")} >
                        S
                      </a>
                    </div>
                ...
                <li className=" ">
                  <div className="row flex  w-full justify-between  mr-4">
                    <div className="row flex items-center ">
                      ...
                      /> */}
                      <a className="ml-2 text-sm font-medium text-gray-700 hover:text-red-700 cursor-pointer " onClick={()=>filterSizeProduct("M")} >
                        M
                      </a>
                    </div>
                    <div className="row text-gray-400 hover:text-red-600 ">
                  ...
                  <div className="row flex  w-full justify-between  mr-4">
                    <label className="row flex items-center ">
                      {/* <input
                        ...
                        className="w-4 h-4"
                      /> */}
                      <a className="ml-2 text-sm font-medium text-gray-700 hover:text-red-700 cursor-pointer " onClick={()=>filterSizeProduct("L")}>
                        L
                      </a>
                    </label>
                    <div className="row text-gray-400 hover:text-red-600 ">
        ...
        <div className="relative w-[280px] -b ">
          ...
          />
          <div className=" h-12 w-full flex items-center ">
            <h1 className="font-semibold pl-4">colors</h1>
          </div>
            ...
            <div className="p-4 w-full">
              <nav className="flex flex-col space-y-3 list-none">
                ...
                <li className=" ">
                  <div className="row flex  w-full justify-between  mr-4">
                    <div className="row flex items-center ">
                      <a className="ml-2 text-sm h-6 w-6 border bg-yellow-500 rounded-full font-medium text-gray-700 hover:text-red-700 " onClick={()=>filterColorProduct("green")} >
                        
                      </a>
                      <a className="ml-2 text-sm h-6 w-6 border bg-red-700 rounded-full font-medium text-gray-700 hover:text-red-700 " onClick={()=>filterColorProduct("green")} >
                        
                      </a>
                      <a className="ml-2 text-sm h-6 w-6 border bg-green-600 rounded-full font-medium text-gray-700 hover:text-red-700 " onClick={()=>filterColorProduct("green")} >
        ...
        <div className="flex w-72 h-full mt-5">
          ...
          <div className="pl-3 pt-5">
            ...
            <h2 className="text-red-500 cursor-default">
        ...
        <div className="flex w-72 h-full mt-4">
          <img
            style={{ backgroundImage: `url(${slides[currentIndex].url2})` }}
            className="w-28 h-28 bg-cover bg-center cursor-pointer"
          ></img>
          <div className="pl-3 pt-5">
            <h2 className="hover:text-red-500 cursor-pointer duration-300">
        ...
        <div className="flex w-72 h-full mt-4">
          <img
            style={{ backgroundImage: `url(${slides[currentIndex].url3})` }}
            className="w-28 h-28 bg-cover bg-center cursor-pointer"
          ></img>
          <div className="pl-3 pt-5">
            <h2 className="hover:text-red-500 cursor-pointer duration-300">
              {slides[currentIndex].title5}
            </h2>
            <h2 className="text-red-500 cursor-default">
              {slides[currentIndex].title6}
            </h2>
            <span className="flex text-red-600">
              <AiFillStar /> <AiFillStar /> <AiFillStar /> <AiFillStar />{" "}
              <AiFillStar />
