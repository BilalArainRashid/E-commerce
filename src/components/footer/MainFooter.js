...
const MainFooter = () => {
  return (
    <div className="">
      <div className="flex flex-wrap mx-2 md:flex md:ml-4">
        <div className="flex flex-col md:flex-row md:space-x-36 text-gray-600 font-semibold">
          ...
          <div className="w-full mt-4  sm:w-1/2 lg:w-2/12">
            <ul>
              <a className="hover:text-red-600 mb-2 inline-block cursor-pointer">
                Shorts
              </a>
        ...
        <div className="mt-4">
          <p className="text-gray-900 font-semibold bg-black-100  : 0.75rem;">
            <h1 className="text-3xl">
              Join our newsletter and get $20 for 
              your first order
            </h1>
          </p>
          <form className="w-full mt-6">
            <div className="rounded-md sm:flex inset-5 ">
              <input
                ...
                className="text-gray-400 w-1/2 h-11  px-4 border rounded-full focus:outline "
              />
              <button
                type="button"
                className="bg-red-600 hover:bg-red-300 w-1/2 h-11 px-8 rounded-full text-white "
              >
                Subscribe
              </button>
            </div>
